# Hi, I'm Ankit Lohia 👋 (https://github.com/ANKU-LOHIA/BookMyShow/)
...
```bash
git clone "git@github.com:ANKU-LOHIA/BookMyShow.git"
```
...
For Frontend
```https
(https://bookmyshow-tickets.netlify.app/)
```
...
```https
[bookmyshowApp](https://bookmyshow-tickets.netlify.app/)
```
...
## Link to website -> [BookMyShow](https://bookmyshow-tickets.netlify.app/)


#### Overall UI of the app.

![App Screenshot](https://snipboard.io/Aj57D4.jpg)

#### Getting confirmations from server.

![App Screenshot](https://snipboard.io/GqCvWh.jpg)

#### Information about previous booking details.

![App screenshot](https://snipboard.io/qHTDJA.jpg)
...
##
<h4 align="center">Made with ❤️ from Ankit </h4>
